...
class MockTraderSpi {
 public:
  ...
  void PublishOrderEvent(const qtrade::sdk::trader::Order& order_info,
  ...
  /// @param session_id 会话标识。
  void PublishTradeEvent(const qtrade::sdk::trader::Trade& trade_info, std::uint64_t session_id);
